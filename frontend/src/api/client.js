...
// Use relative /api so Vercel proxies to Railway — eliminates CORS entirely
const API_BASE = '/api'
...
// Trailing slashes match FastAPI routes exactly — avoids 307 redirect that breaks Auth header
